...
Velow Notebook 是面向大学生的本地优先学习工作台。当前仓库已经完成里程碑 2 的学习计划验收：计划页支持按日期组织任务、用学期与假期管理阶段、在离线状态下继续创建与完成任务，并覆盖移动端到桌面的响应式与无障碍回归。
...
- 学习计划四视图：日、周、月、周期
- 学期 / 寒暑假周期管理：创建、编辑、删除、重叠校验与跨周期任务复制
- 计划任务创建、编辑、删除、完成、改期与排序校验
- 右滑完成、350ms 长按拖动改期、键盘 Enter / Space 完成、操作菜单改期
...
- 周视图：浏览一周任务分布，在桌面网格中调整日期
- 月视图：按月查看任务密度与完成数，选中某天后查看该日任务
- 周期视图：管理学期 / 假期范围，查看当前周期上下文，并把上周期未完成任务复制到新周期
...
- `pnpm test:e2e`：学习计划创建、三视图、真实指针手势、周期复制、响应式、无障碍、减弱动画与离线持久化
