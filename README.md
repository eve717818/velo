...
- 简化版 Obsidian 笔记工作台：知识树支持多个根目录与无限层级、完整路径、节点旁按需新建、移动/重命名与 Markdown 导出
...
- 笔记工作台不显示回收站，也不提供“移到回收站”操作；“导出 Markdown”会先等待当前草稿成功保存。真实 PDF 导出将在后续放到右侧内容页标题栏，并调用安卓系统保存/分享面板，下载作为回退
...
所见即所得笔记编辑、笔记搜索和真实 PDF 导出是已确认的后续笔记子项目。数理化公式、拍照录入、录音、AI 和同步不进入当前首版。
